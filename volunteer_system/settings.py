...
def _patched_context_copy(self):
    duplicate = _original_context_copy(self)
    # Вручную устанавливаем необходимые атрибуты
    duplicate.dicts = getattr(self, 'dicts', [])[:]
    duplicate._reset_dict = getattr(self, '_reset_dict', {})
    return duplicate
...
INSTALLED_APPS = [
    'django.contrib.admin',  # Оставляем, но не будем использовать
    'django.contrib.auth',
    ...
    'accounts',
    'events',
    'custom_admin',  # Добавляем кастомную админку
]
MIDDLEWARE = [
